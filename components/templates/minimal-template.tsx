...
export default function MinimalTemplate({
  ...
  return (
    ...
    >
      ...
      {experience.length > 0 && (
        <section className="mb-6">
          <h2 className="text-lg font-semibold text-slate-900 mb-4 border-b border-slate-200 pb-1">
            Experience
          </h2>
        ...
        <section>
          ...
          <div className="flex flex-wrap gap-1">
            {skills.map((skill) => (
              <span
                key={skill.id}
                className="border border-slate-200 text-slate-700 px-3 py-1 rounded-sm text-sm"
              >
                {skill.name}
              </span>
            ))}
