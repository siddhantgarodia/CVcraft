...
export default function CreativeTemplate({ resumeData, profileImage }: CreativeTemplateProps) {
  ...
  return (
    <div className="bg-white shadow-sm min-h-[1056px] w-[816px] mx-auto font-sans">
      ...
      <div className={`bg-${accentColor}-600 text-white p-8`} style={{ backgroundColor: "#059669" }}>
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            {personalInfo.title && <p className="text-xl opacity-90">{personalInfo.title}</p>}
          </div>
        </div>

        {personalInfo.summary && (
          <p className="text-sm leading-relaxed opacity-90 mt-4 max-w-2xl">{personalInfo.summary}</p>
        )}
      </div>
                  ...
                  {experience.map((exp) => (
                    ...
                    >
                      ...
                      <div className="mb-1">
                        ...
                        <p className={`font-medium text-${accentColor}-600`} style={{ color: "#059669" }}>
                          {exp.company}
                        </p>
                      </div>
                      ...
                      <p className="text-slate-700 text-sm whitespace-pre-line">{exp.description}</p>
                    </div>
                  ))}
                </div>
              </section>
                  ...
                  {skills.map((skill) => (
                    <div key={skill.id}>
                      <div className="flex justify-between mb-1">
                        ...
                        <span className={`text-xs text-${accentColor}-600`} style={{ color: "#059669" }}>
                          {skill.level}
                        </span>
                      </div>
